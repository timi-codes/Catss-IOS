...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        UITabBar.appearance().tintColor = Color.accentColor
        UITabBar.appearance().barTintColor = Color.primaryColor
        UITabBar.appearance().isTranslucent = false
        
        //Set custom Bottom bar as entry point to the app
        let bottomVC = BottomTabController()
        let navVc = UINavigationController(rootViewController: bottomVC)
...
//        )
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Catss_ios")
